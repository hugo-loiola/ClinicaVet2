...
const form = () => {
  ...
  const [veterinarios, setCliente] = useState([]);

  useEffect(() => {
    if (query.id) {
      axios.get(`/api/veterinarioss/${query.id}`).then((res) => {
  ...
  function salvar(dados) {
    axios.put(`/api/veterinarioss/${dados.id}`, dados);
    push(`/veterinarioss/${veterinarios.id}`);
  }
    ...
    <Pagina titulo="Editar Cliente">
      <Form>
        ...
        <div className="text-center">
          ...
          <Link
            href={`/veterinarioss/${veterinarios.id}`}
